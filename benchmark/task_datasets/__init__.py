DATA_DIR = '/data1/lvyuanhuiyi/meisen/instructllama/benchmark_evaluation/DATA_DIR'

from .ocr_datasets import ocrDataset
from .caption_datasets import NoCapsDataset, FlickrDataset, COCOCaptionDataset, COCOCaptionDatasetTest, TextCapsDataset
