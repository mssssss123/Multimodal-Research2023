...
from src.utils.constants import eva_clip_g_path
...
def create_eva_vit_g(img_size=224, drop_path_rate=0.4, use_checkpoint=False, precision="fp16"):
    ...
    # cached_file = '/data2/meisen/pretrained_model/eva-clip-g/eva_vit_g.pth'
    state_dict = torch.load(eva_clip_g_path, map_location="cpu")
